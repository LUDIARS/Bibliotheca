// !! Vendored copy of LUDIARS/Corpus public/src/render/renderer.ts (2026-05-23). !!
// !! 編集禁止 — Corpus 側を更新したら本ファイルも上書きで同期させる。
// !! 将来 @ludiars/corpus-renderer パッケージ化されたら本コピーを撤去する
// !! (Corpus DESIGN.md §13.7)。
//
